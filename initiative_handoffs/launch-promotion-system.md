...
Title:
- Turn the launch promotion system into an execution plan

Why it matters:
- PSF now has a stronger promotion architecture, but it still needs to be translated into launch-ready work that Mike and Josiah can actually execute before and after Ballina.

Best lane for this work:
- Marketing chat first, with follow-on handoffs into launch ops, Beehiiv, and gym outreach if needed

What is already decided:
- PSF growth should be treated as one connected promotion system.
- The current launch-era lanes are launch and field marketing, comp and giveaway engine, referral loop, organic social, individual ambassador and sponsor-interest capture, gym partnerships, and paid social.
...
What to do first:
- Read the linked docs, then turn the launch-era promotion system into a plain-English execution plan with initiatives, task groups, owners, sequencing, and a short list of things that are intentionally deferred.
...
- Do not treat paid social as equal priority with the launch basics.
- Do not let a complex ambassador or sponsor program delay launch.
- Do not let optional interest-capture make the primary signup or referral flow confusing.
- Keep the output usable by a non-technical reader.
...
- [POSITIONING.md](/Users/Mike/dev/Pinchy%20Slab%20Face/POSITIONING.md)
